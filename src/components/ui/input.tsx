...
const baseField =
  "w-full rounded-xl border border-white/15 bg-surface px-3.5 py-2.5 text-sm text-white placeholder:text-zinc-500 transition-colors focus:border-brand-500 focus:outline-2 focus:outline-brand-500/20 disabled:opacity-50";
