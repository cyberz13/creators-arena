-- CREATORS ARENA — PostgreSQL (Supabase) schema.
-- Mirrors schema.sql; timestamps are unix epoch ms → BIGINT.
...
CREATE TABLE IF NOT EXISTS campaigns (
  ...
  finalized_at   BIGINT,
  report_token   TEXT,
  report_token_expires_at BIGINT,
  report_views   INTEGER NOT NULL DEFAULT 0,
  report_last_viewed_at BIGINT,
